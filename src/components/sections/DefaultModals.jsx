      ...
      <div className="bg-black bg-opacity-80">
        <SectionArea id="service">
          ...
          <SectionWrapper>
            ...
            <div className="w-full"><p className="text-white text-paragraph2 mt-[26px] tablet1:mt-[40px] desktop1:mt-[72px] text-center">Nossa empresa está em total conformidade com a Lei Geral de Proteção de Dados (LGPD). Para garantir a segurança e a privacidade das suas informações, a confirmação de inscrição será realizada exclusivamente por e-mail e/ou WhatsApp, após o envio do formulário preenchido. Pedimos que complete o formulário de maneira detalhada para que nossa equipe possa entrar em contato e concluir sua inscrição.
