export default function BannerDestaque() {
  const coverImage =
    "https://licitacoesnapratica.mapacursos.com/images/capa-licitacoes.jpg";
  const folderImage =
    "https://licitacoesnapratica.mapacursos.com/images/folder-licitacoes.jpg";
        ...
        <div className="grid w-full gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div>
            ...
            <div className="flex flex-col gap-4 mt-10 sm:flex-row sm:items-center">
              <a
                href="https://licitacoesnapratica.mapacursos.com/"
                target="_blank"
              >
              ...
              <a
                href="https://wa.me/5545991290837?text=Ol%C3%A1%2C%20gostaria%20de%20obter%20mais%20informa%C3%A7%C3%B5es%20sobre%20o%20curso%20Licita%C3%A7%C3%B5es%20na%20Pr%C3%A1tica."
                target="_blank"
                rel="noreferrer"
